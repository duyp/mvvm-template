...
import com.duyp.architecture.mvvm.model.BranchesModel;
...
import com.duyp.architecture.mvvm.model.CreateMilestoneModel;
import com.duyp.architecture.mvvm.model.Label;
import com.duyp.architecture.mvvm.model.MarkdownModel;
import com.duyp.architecture.mvvm.model.MilestoneModel;
import com.duyp.architecture.mvvm.model.Pageable;
import com.duyp.architecture.mvvm.model.Release;
import com.duyp.architecture.mvvm.model.Repo;
import com.duyp.architecture.mvvm.model.RepoFile;
import com.duyp.architecture.mvvm.model.RepoSubscriptionModel;
import com.duyp.architecture.mvvm.model.TreeResponseModel;
...
public interface RepoService {
    ...
    Observable<Pageable<Label>> getLabels(@NonNull @Path("owner") String owner, @NonNull @Path("repo") String repo);

    @NonNull @GET("repos/{owner}/{repo}/labels?per_page=100")
    Observable<Pageable<Label>> getLabels(@NonNull @Path("owner") String owner, @NonNull @Path("repo") String repo, @Query("page") int page);

    @NonNull @POST("repos/{owner}/{repo}/labels")
    Observable<Label> addLabel(@NonNull @Path("owner") String owner, @NonNull @Path("repo") String repo, @Body Label body);
