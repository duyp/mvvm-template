...
import com.duyp.architecture.mvvm.test_utils.ModelTestUtils;

import org.junit.Test;

import javax.inject.Inject;

import static com.duyp.architecture.mvvm.local.RealmTestUtils.initLiveRealmObject;
...
public class RepoDetailRepoTest extends BaseDataModuleTest {
    ...
    private final Repo mRepo = sampleRepository(1L, ModelTestUtils.sampleUser(1L));
